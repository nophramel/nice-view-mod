...
// This is the custom 1-Bit Art for the APP_BAKERY_LOGO_SIMPLIFIED_NEGATIV_68X140

#ifndef LV_ATTRIBUTE_IMG_APP_BAKERY_LOGO_SIMPLIFIED_NEGATIV_68X140
#define LV_ATTRIBUTE_IMG_APP_BAKERY_LOGO_SIMPLIFIED_NEGATIV_68X140
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST
    LV_ATTRIBUTE_IMG_APP_BAKERY_LOGO_SIMPLIFIED_NEGATIV_68X140 uint8_t
        app_bakery_logo_simplified_negativ_68x140_map[] = {
#if CONFIG_NICE_VIEW_WIDGET_INVERTED
            0xff, 0xff, 0xff, 0xff, /*Color of index 0*/
            0x00, 0x00, 0x00, 0xff, /*Color of index 1*/
#else
            ...
            ,
};

const lv_img_dsc_t app_bakery_logo_simplified_negativ_68x140 = {
    .header.cf = LV_IMG_CF_INDEXED_1BIT,
    .header.always_zero = 0,
    .header.reserved = 0,
    .header.w = 140,
    .header.h = 68,
    .data_size = 1232,
    .data = app_bakery_logo_simplified_negativ_68x140_map,
};
